...
class ToDoTableViewController: UITableViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {
        getToDos()
        //view loads up for user and calls this function to store inside the toDos variable
//        toDos = createToDos()
...
//    }
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
       //gives us rows equivalent to the data stored
        return toDos.count
    }
...
//this happens when the user is using the segue to go to the other view
